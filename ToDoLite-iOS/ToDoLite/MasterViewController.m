...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"showDetail"]) {
        ...
        CBLDocument *listDocument = [self.database documentWithID: @"-qQHHyARidBVOOY0Yl-EnMN"];
        // Need to learn how to construct a List object
        
        //List *list = [List modelForDocument:listDocument];
